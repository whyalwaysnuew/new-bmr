<?php 
    ...
    $activities = mysqli_query($koneksi, "SELECT * FROM activity_scale");
?>
...
<head>
    ...
    <title>Skala Aktifitas - BMR Calculator</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Skala Aktifitas</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Data Skala Aktifitas</h6>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        <?php if($activities) {?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle"><?= $activity['scale']; ?></td>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Edit <?= $activity['name']; ?></h5>
                                                            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">×</span>
                                                            </button>
                                                        </div>
                                                        <form action="app/activity-scale/update.php" method="post">
                                                            <div class="modal-body">
                                                                <input type="hidden" name="id" id="id" value="<?= $activity['id']; ?>">
                                                                <div class="form-group">
                                                                    <label for="name">Nama</label>
                                                                    <input type="text" class="form-control" id="name" name="name" placeholder="e.g. Jarang" value="<?= $activity['name']; ?>" required>
                                                                </div>

                                                                <div class="form-group">
                                                                    <label for="scale">Skala</label>
                                                                    <input type="text" class="form-control" id="scale" name="scale" placeholder="e.g. 250" value="<?= $activity['scale']; ?>" required>
                                                                </div>
                                            ...
                                            <div class="modal fade" id="deleteModal<?= $key ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="app/activity-scale/delete.php" method="post">
                                                            <div class="modal-body">
                                                                <input type="hidden" name="id" id="id" value="<?= $activity['id']; ?>">
                                                            </div>
                                                            <div class="modal-footer">
    ...
    <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="app/activity-scale/store.php" method="post">
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="name">Nama</label>
                            <input type="text" class="form-control" id="name" name="name" placeholder="e.g. Jarang">
                        </div>

                        <div class="form-group">
                            <label for="scale">Skala</label>
                            <input type="text" class="form-control" id="scale" name="scale" placeholder="e.g. 250"required>
                        </div>
